...
public class Example_4 extends JFrame{
	...
	private void Accion_resultado() {
		...
		button.addActionListener((accion) -> {
			...
			palabras.add(Palabra1.getText());
			palabras.add(Palabra2.getText());
			palabras.add(palabra3.getText());
			Collections.sort(palabras);
			PalabrasOrdenados.setText(null);
			for(int i = 0; i < palabras.size(); i++) {
				PalabrasOrdenados.append(palabras.get(i) + " ");
			}
